 ...
 * 
 */
class TipodocumentoFilter  extends InputFilter
{ 
    // Add this property:    
    private $dbAdapter;
         ...
         $this->add([
            ...
            'validators' => [
                ...
                ['name' =>NoRecordExists::class,
                          'options' => [
                            'table' => 'tipo_documento_fiscal',
                            'field' => 'Nombre_Documento',
                            'adapter' =>  $this->dbAdapter,
                            'messages' => [
                                \Zend\Validator\Db\NoRecordExists::ERROR_RECORD_FOUND => 'El documento fiscal ya existe',
                           ],
                        ],
                  ],
            ],

...
class UnidadTransporteFilter  extends InputFilter
{ 
  // Add this property     
    private $dbAdapter;    
            ...
            'filters' => [
             ...
             'validators' => [
                ...
                ['name' =>NoRecordExists::class,
                          'options' => [
                            'table' => 'unidades_de_transporte',
                            'field' => 'Cod_Unidad',
                            'adapter' =>  $this->dbAdapter,
                            'messages' => [
                                \Zend\Validator\Db\NoRecordExists::ERROR_RECORD_FOUND => 'El código de unidad de transporte ya existe',
                           ],
                        ],
                ],
            ],
            ...
            'validators' => [
                ...
                ['name' =>NoRecordExists::class,
                          'options' => [
                            ...
                            'adapter' =>  $this->dbAdapter,
                            'messages' => [
                                \Zend\Validator\Db\NoRecordExists::ERROR_RECORD_FOUND => 'La placa de vehiculo ya existe',
                           ],
                        ],
                ],
            ],
